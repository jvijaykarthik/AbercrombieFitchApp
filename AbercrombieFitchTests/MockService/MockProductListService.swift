    ...
    func fetchProducts() async throws -> [AbercrombieFitch.Product] {
        if shouldReturnError {
            ...
            return [
                ...
                Product(title: "Product 2", backgroundImage: "image2.jpg", promoMessage: nil, topDescription: "Top 2", bottomDescription: "Bottom 2", content: [Content(title: "ContentTitle", target: "https://abercrombie.com", elementType: "hyperlink")])
            ]
        }
    }
